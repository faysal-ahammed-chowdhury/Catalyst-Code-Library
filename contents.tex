...
\inputminted[breaklines, breakanywhere]{c++}{code/01-Setup/05-Template.cpp}

\subsection{\small Input Gen  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/01-Setup/06-Input Gen.cpp}

\subsection{\small Bash Script  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/01-Setup/07-Bash Script.cpp}
...
\subsection{\small Treap  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/05-Data Structure/27-Treap.cpp}

\subsection{\small Centroid Decomposition  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/05-Data Structure/28-Centroid Decomposition.cpp}
...
\section{Flow}
\subsection{\small Flow wtth L H bound  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/10-Flow/02-Flow wtth L H bound.cpp}

\subsection{\small Hopcroft Karp  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/10-Flow/03-Hopcroft Karp.cpp}

\subsection{\small L H (work with cycle)  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/10-Flow/04-L H (work with cycle).cpp}

\subsection{\small Max-Flow  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/10-Flow/05-Max-Flow.cpp}

\subsection{\small Max Flow with Min Cost  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/10-Flow/06-Max Flow with Min Cost.cpp}

\subsection{\small Flow Properties  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/10-Flow/17-Flow Properties.cpp}
...
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./02-[Trick] Median of Medians.cpp}
...
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./04-Ternary Search.cpp}

\subsection{\small Pigeonhole Principle  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./05-Pigeonhole Principle.cpp}
...
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./07-Matrix Expo.cpp}

\subsection{\small 2D Prefix Sum  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./08-2D Prefix Sum.cpp}

\subsection{\small 2D Static Range Update  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./09-2D Static Range Update.cpp}

\subsection{\small CHECK SET CLR  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./10-CHECK SET CLR.cpp}

\subsection{\small Graph Directions  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./11-Graph Directions.cpp}

\subsection{\small Custom Hash  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./12-Custom Hash.cpp}

\subsection{\small Coordinate Compression  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./13-Coordinate Compression.cpp}

\subsection{\small Submask Generator  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./14-Submask Generator.cpp}

\subsection{\small Custom Comparators  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./15-Custom Comparators.cpp}

\subsection{\small MOD Operations  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./16-MOD Operations.cpp}

\subsection{\small Mex with Array Updates  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./17-Mex with Array Updates.cpp}

\subsection{\small Check Eq AlphaQ  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/11-Misc./18-Check Eq AlphaQ.cpp}

\section{Geometry}
\subsection{\small Convex Hull  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/12-Geometry/01-Convex Hull.cpp}

\subsection{\small Area of 2 polygon intersection  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/12-Geometry/02-Area of 2 polygon intersection.cpp}

\subsection{\small Point Segment Distance  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/12-Geometry/03-Point Segment Distance.cpp}

\subsection{\small Three Point Circle  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/12-Geometry/04-Three Point Circle.cpp}

\subsection{\small Circle Line Intersection  \scriptsize}
\inputminted[breaklines, breakanywhere]{c++}{code/12-Geometry/05-Circle Line Intersection.cpp}
